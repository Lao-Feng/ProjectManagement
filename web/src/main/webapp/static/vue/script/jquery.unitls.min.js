...
(function($) {
	$.parser = {
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination",
				...
				"progressbar", "tree", "textbox","textbox1", "filebox", "combo",
					...
					if (typeof pp == "string") {
						...
						for ( var _f in pp) {
							...
							if (_10 == "boolean") {
								...
								if (_10 == "number") {
									_e[_f] = t.attr(_f) == "0" ? 0
											: parseFloat(t.attr(_f)) || undefined;
								}
							}
						}
					}
...
(function($) {
	...
	function _8a(_8b) {
		...
		t.attr("id", _8c.id || "");
		var _8d = $("<span class=\"layui-btn layui-btn-sm\"></span>").appendTo(t);
		if (_8c.text) {
			$("<span class=\"l-btn-text\"></span>").html("<i class=\"el-icon-document\"></i>"+_8c.text)
					.appendTo(_8d);
		} else {
	...
	function _20d(_20e) {
		...
		function _211() {
			...
			if (opts.title && !opts.noheader) {
				...
				if(opts.title=="maintitle"){
					_214 = $(
					"<div id=\"menutile1\" name=\"menutile1\" class=\"panel-title\"></div>")
					.html(" ").appendTo(_213);
				}else{
					_214 = $(
					"<div id=\"menutile\" name=\"menutile\" class=\"panel-title\"></div>")
		...
		function _3c0(menu) {
			...
			if (menu.hasClass("menu-content")) {
				...
				menu.children("div").each(
						function() {
							var item = $(this);
							var _3c3 = $.extend( {}, $.parser.parseOptions(
...
(function($) {
	...
	function _4ff(_500, year, _501) {
		...
		while (_508.length < 7) {
			...
			_508.push( [ date.getFullYear(), date.getMonth() + 1,
					date.getDate() ]);
		}
		if (_504.length < 6) {
			var _509 = _508[_508.length - 1];
				...
				for ( var j = 0; j < cols.length; j++) {
					...
					if (col.checkbox) {
						...
						if (opts.singleSelect) {
							$(
									"<div class=\"datagrid-header-check check-hidden\"></div>")
...
function OpenFullUrl(url,w,h){
   parent.OpenNewWin(url,w,h);
}
