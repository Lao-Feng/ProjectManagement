   ...
   $.fn.Flowdesign = function(options)
    ...
    jsPlumb.bind("click", function(c) {
      ...
      var eid=c.targetId;
             ...
             var show = document.all.item('type').value;
             ...
             //-----------
             if (cid.indexOf('S')>=0 || cid.indexOf('E')>=0 || eid.indexOf('S')>=0 || eid.indexOf('E')>=0)
             {
                  layer.confirm("连接开始或结束的连接线不能设置属性！确定要删除吗？",{icon:3, title:'提示'},function(index){
			cid=repl(cid,"windowS","");
                        cid=repl(cid,"windowE","");
                        cid=repl(cid,"windowZ","");
                        cid=repl(cid,"window","");
                        eid=repl(eid,"windowS","");
                        eid=repl(eid,"windowE","");
                        eid=repl(eid,"windowZ","");
                        eid=repl(eid,"window","");

                        OpenSetup3("/flow/openflowcfg?Act=deleteconnid&cid="+ cid+"&eid="+eid);
             ...
             }else
             {
               ...
               eid=repl(eid,"windowZ","");
               eid=repl(eid,"window","");
               OpenSetup1("/flow/openflowcfg?Act=ManageActivityConne&cid="+ cid+"&eid="+eid);
              }
              //-----------
