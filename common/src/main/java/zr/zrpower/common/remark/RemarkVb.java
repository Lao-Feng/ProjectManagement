...
public class RemarkVb {
	...
	public static final String get() {
		...
		sb.append("  For Index = 0 To xmlele.childNodes.length - 1\n");
		...
		sb.append("     page = xmlele.childNodes.Item(Index).Attributes.Item(3).Text\n");
		...
		sb.append("        elseif mode = \"3\" then\n");
		sb.append("            imglink = \"ZrCollEngine/Print/Remark.gif\"\n");
		sb.append(
				"               document.write \"<div id='divid\" & Index & \"' onmouseup='updatexml(\" & Index & \",\" & id &\",thisx(this),thisy(this))'  onmouseover=\" & chr(34) & \"MM_dragLayer('divid\" & Index &  \"','',0,0,0,0,true,false,-1,-1,-1,-1,false,false,0,'',false,'')\" &  chr(34) & \"  style='background-color:transparent;position:absolute;filter:alpha(opacity=85);cursor:default;left:\" &  x & \"px;top:\" & y & \"px;'><img style='cursor:move' Title='按住鼠标拖动可将公章拖动到适合的位置' src='\" & imglink &\"'></div>\"\n");
		sb.append("        end if\n");
		sb.append("     end if\n");
		...
		sb.append("end Function\n");
		sb.append("\n");
		sb.append("Function updatexml(myindex,id,x,y)\n");
		sb.append("  Set xmldoc = createobject(\"Microsoft.XMLDOM\")\n");
		sb.append("  xmldoc.async = False\n");
		sb.append("  a = xmldoc.LoadXML(XML)\n");
		sb.append("  if a = false then\n");
		sb.append("     msgbox \"Load XML error！\"\n");
		sb.append("  end if\n");
		sb.append("  Set xmlele = xmldoc.documentElement\n");
		sb.append("  Set node = xmlele.childnodes.item(myindex)\n");
		sb.append("  if x<>\"\" and y<>\"\" then\n");
		sb.append("    node.Attributes.Item(1).Text = x\n");
		sb.append("    node.Attributes.Item(2).Text = y\n");
		sb.append("  end if\n");
		sb.append("  XML= xmldoc.xml\n");
		sb.append("  document.frmCachat.PmXML.value = XML\n");
		sb.append("end Function\n");
		sb.append("\n");
		sb.append("Function insertxml(id,x,y,page)\n");
		sb.append("  Set xmldoc = createobject(\"Microsoft.XMLDOM\")\n");
		sb.append("  xmldoc.async = False\n");
		sb.append("  a = xmldoc.LoadXML(XML)\n");
		sb.append("  Set xmlele = xmldoc.documentElement\n");
		sb.append("  Set node = xmldoc.createNode(1, \"PM\", \"\")\n");
		sb.append("  xmlele.insertBefore node, node.lastChild\n");
		sb.append("  Set node1 = xmldoc.createNode(2, \"id\", \"\")\n");
		sb.append("  node.Attributes.setNamedItem (node1)\n");
		sb.append("  Set node1 = xmldoc.createNode(2, \"x\", \"\")\n");
		sb.append("  node.Attributes.setNamedItem (node1)\n");
		sb.append("  Set node1 = xmldoc.createNode(2, \"y\", \"\")\n");
		sb.append("  node.Attributes.setNamedItem (node1)\n");
		sb.append("  Set node1 = xmldoc.createNode(2, \"page\", \"\")\n");
		sb.append("  node.Attributes.setNamedItem (node1)\n");
		sb.append("  node.Attributes.Item(0).Text = id\n");
		sb.append("  node.Attributes.Item(1).Text = x\n");
		sb.append("  node.Attributes.Item(2).Text = y\n");
		sb.append("  node.Attributes.Item(3).Text = page\n");
		sb.append("  XML= xmldoc.xml\n");
		sb.append("  document.frmCachat.PmXML.value = XML\n");
		sb.append("End Function\n");
		sb.append("\n");
