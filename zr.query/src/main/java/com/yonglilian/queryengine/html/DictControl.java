...
public class DictControl extends ControlBase {
    ...
    public DictControl(ItemField itemField, String valueStr) {
        ...
        resultHTML.append("<SELECT name=").append(itemField.getName()).append(" id=").append(
                          ...
                          " style=\"width:").append("180").append(
                          "px;\"   class=easyui-combobox code=").append(
        ...
        resultHTML.append(
                "<IMG SRC=\"/static/ZrQueryEngine/Res/control.gif\" onClick=\"SetSelectValue('").append(
    ...
    private String GetOptionStr(String code, String codeTable) {
        ...
        strSQL.append("Select Code,Name From " ).append(codeTable).append(" Where Code='").append(code).append("'");
