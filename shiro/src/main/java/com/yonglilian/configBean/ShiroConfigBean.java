package com.yonglilian.configBean;


import com.yonglilian.realms.MyShiroRealm;
...
public class ShiroConfigBean {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/springfox*/**", "anon");
        filterChainDefinitionMap.put("/extn*/**", "anon");
        filterChainDefinitionMap.put("/nudge*/**", "anon");
