 ...
 *
 */
public class ZRCollenHtmlUtils {

	/**
	 * 生成代码
	 */
	public static String generatorCode( Map<String, Object> map) {
		...
		// 渲染模板
		Template tpl = Velocity.getTemplate( "template/collview.html.vm", "UTF-8" );
