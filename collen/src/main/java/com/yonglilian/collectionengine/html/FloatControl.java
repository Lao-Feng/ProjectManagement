...
public class FloatControl extends TextControl {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public FloatControl(InputTag inputtag) {
		super(inputtag);
	...
	public void setItemField(ItemField item) {
		...
		mThis.setAttribute(":precision", "2");
	...
	public Object getInitVal() {
		if(mItem.getShowValue()!=null) {
			if(mItem.getShowValue().trim().length()>0) {
				return Float.valueOf(mItem.getShowValue());
			}
			return 0;
		}
		return 0;
